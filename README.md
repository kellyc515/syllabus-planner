...
| **4. Calendar** | Month grid of **graded** work only. Each day shows what's due plus a load bar; days over your cap turn red and get flagged. Check an item off (day panel or the Assignments table) and it stops counting toward workload — completed items stay visible, struck through. |
